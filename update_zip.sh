...
DOWNLOAD_WIMPNETHER_NET_DEVICE_KERNEL=~/otabuilds/full_builds/$DEVICE/kernel
DOWNLOAD_WIMPNETHER_NET_DEVICE_RECOVERY=~/otabuilds/full_builds/$DEVICE/recovery
DOWNLOAD_WIMPNETHER_NET_DEVICE_BLACKHAWK=~/otabuilds/full_builds/$DEVICE/blackhawk
